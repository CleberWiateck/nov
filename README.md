...
<head>
    ...
    <title>Bairro Planejado Vida Nova Santa Rita</title>
    ...
    <style>
        ...
        body {
            ...
            margin: 0;
            padding: 0;
            background: #FFA500; /* Fundo laranja */
        ...
        .container {
            max-width: 100%; /* Ajusta à largura da tela */
            margin: 0 auto;
            padding: 20px;
            background: #fff;
            border-radius: 8px;
        ...
        .image-small img {
            max-width: 48%; /* Ajusta imagens menores */
            height: auto;
            margin: 1%;
            border-radius: 8px;
        }
        ...
        .button {
            ...
            margin: 10px 5px;
            padding: 15px 25px; /* Tamanho maior para dispositivos móveis */
            color: #fff;
            background: #003366;
